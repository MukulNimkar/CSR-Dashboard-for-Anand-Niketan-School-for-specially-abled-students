...
def calculate_kpis(students_df, infra_df):
    ...
    return {
        ...
        "student_funding_gap": f"{int(student_funding_gap):,}",
        "infrastructure_gap": f"{int(infrastructure_gap):,}",
        "total_funding_gap": f"{int(total_funding_gap):,}",
        "funding_coverage_percent": funding_coverage_percent,
        "cost_per_student": f"{int(cost_per_student):,}",
        "cost_per_improvement_point": f"{int(cost_per_improvement_point):,}",
